...
export class AdminReportController {
   ...
   */
    ...
    /**
     * Get reports by source user ID
     * @route GET /api/admin/reports/source/:id
     */
    static async getReportsBySourceUserId(req: Request, res: Response): Promise<void> {
      try {
        const { userId } = req.params;
        ...
        const reports = await AdminReportService.getReportsBySourceUserId(Number(userId));
